...
class CRM_Contact_Form_Search_Custom_DaysAdded
   ...
   implements CRM_Contact_Form_Search_Interface {
    ...
    function buildForm( &$form ) {
         ...
         */
        $form->assign( 'elements', array( 'start_date', 'end_date', 'includeGroups', 'excludeGroups', 'number_of_days' ) );
    }
