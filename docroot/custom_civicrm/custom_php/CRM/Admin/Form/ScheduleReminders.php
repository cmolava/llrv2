...
class CRM_Admin_Form_ScheduleReminders extends CRM_Admin_Form {
  ...
  public function buildQuickForm() {
    ...
    $choice    = array();
    $attribute = array('id_suffix' => 'hard_or_soft_credit');
    $choice[]  = $this->createElement('radio', NULL, '11', ts('Hard Credit'), '0', $attribute);
    $choice[]  = $this->createElement('radio', NULL, '11', ts('Soft Credit'), '1', $attribute);
    $this->addGroup($choice, 'hard_or_soft_credit', ts('Hard Or Soft Credit?'));
    ...
    // PS Removed CRM_Core_PseudoConstant::staticGroup()
    $this->add('select', 'group_id', ts('Group'),
      CRM_Core_PseudoConstant::group(), FALSE, array('class' => 'crm-select2 huge')
    );
  ...
  function setDefaultValues() {
    ...
    if (empty($defaults['hard_or_soft_credit'])) {
      $defaults['hard_or_soft_credit'] = '0';
    }
