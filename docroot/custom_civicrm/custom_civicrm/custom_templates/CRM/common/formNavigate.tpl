<!-- Customised Civi File .tpl file invoked: custom_civicrm/custom_templates/CRM/common/fromNavigate.tpl Call via form.tpl if we have a form in the page. -->
{*
 +--------------------------------------------------------------------+
 | CiviCRM version 4.1                                                |
 +--------------------------------------------------------------------+
