...
$strDatabaseUser="digitaluser"; // Change this if you created a different user name to access the database
$strDatabasePassword="d1g1t4lu53r"; // Set the password for the above user here d1g1t4lu53r
...
/**$strYourSiteFQDN="http://uat.lalr.org.uk/";

$strVendorName="leukaemialympho"; // Set this value to the Vendor Name assigned to you by Sage Pay or chosen when you applied
