<!-- Customised Civi File .tpl file invoked: custom_civicrm/custom_templates/CRM/Event/Form/ManageEvent/Fee.tpl Call via form.tpl if we have a form in the page. -->
{*
 +--------------------------------------------------------------------+
 | CiviCRM version 4.3                                                |
 +--------------------------------------------------------------------+
...
<div class="crm-submit-buttons">
  ...
  <table id="discounts" class="form-layout">
    <tr>
      <td class="label">{$form.percentage_discount.label}</td><td style="width:145px">{$form.percentage_discount.html}</td>
      <td class="description">Provide the discount as a percentage and give the threshold in the field below.</td>
      
    </tr>
    <tr>
      <td class="label">{$form.attendee_threshold.label}</td><td style="width:145px">{$form.attendee_threshold.html}</td>
      <td class="description">Provide the amount pf people required to get the bulk discount.</td>
      
    </tr>
     <tr>
      <td class="label">{$form.family_discount.label}</td> <td style="width:145px">{$form.family_discount.html}</td>
      <td class="description">Provide the discount price for the whole family.</td>
