...
abstract class CRM_DirectDebit_Utils_Hook {
   ...
   * @access public
   */
  static function alterSmartDebitContributionParams( &$contribuitonParams, $smartdebitParams) {
	  return self::singleton( )->invoke( 2, $contribuitonParams, $smartdebitParams, self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject, 'civicrm_alterSmartDebitContributionParams' );
  }
  ...
  static function handleSmartDebitMembershipRenewal( &$params ) {
   ...
   /**
   * This hook allows to handle contact not matched for the DD import
   * @param array   $params     Contribution params
   *
   * @access public
   */
  static function findSmartDebitContact( &$params ) {
    return self::singleton( )->invoke( 1, $params, self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject, self::$_nullObject, 'civicrm_findSmartDebitContact' );
  }
}
